...
Contemplamos otras posibles soluciones al problema, entre ellas:

- Un enfoque bruto, probando todos los pares sin validación previa.
- Uso de estructuras más avanzadas como árboles de intervalos.
- Representación mediante matrices.

Sin embargo, estas alternativas presentan mayor coste computacional.
